    ...
    <div>
        ...
        <el-card>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4">
                    <el-button type="primary" @click="addDiaologVisible =true">添加用户</el-button>
                </el-col>
            </el-row>
            <!-- 用户列表区域 -->
            <el-table :data="userlist" stripe stripe>
        ...
        <!-- 添加用户对话框 -->
        <el-dialog title="提示" :visible.sync="addDiaologVisible" @close="addDiaologClosed">
            <!-- 内容主体区域 -->
    ...
    export default {
            ...
            return {
                ...
                addFormRules: {
                    ...
                    email: [
                        ...
                        { min: 10, max: 30, message: '邮箱长度在10 - 30字符之间', trigger: 'blur' }, { validator: checkEmail, trigger: 'blur' }
                    ],
                    //手机
                    mobile: [
                        { required: true, message: '请输入手机', trigger: 'blur' },
                        { min: 10, max: 11, message: '手机长度在10 - 11字符之间', trigger: 'blur' }, { validator: checkMobile, trigger: 'blur' }
                    ]
                },
                //控制修改用户对话框的显示和隐藏
        ...
        methods: {
            ...
            async removeUserById(id) {
                ...
                //用户确定删除,返回值为字符串 confirm
                //用户取消删除,则返回值为字符串 cancel
